...
//
//     expect(msg).to.deep.equal("falsetruefalse");
//     expect(numbers).to.deep.equal([1, 2, 3]);
//   });
//
...
//       expect(_.range(1, 4)).to.deep.equal([1, 2, 3]);
//       expect(_.range(0, -4, -1)).to.deep.equal([0, -1, -2, -3]);
//   });
//
//   it("should use flatten to make nested arrays easy to work with", function() {
//       expect(_([ [1, 2], [3, 4] ]).flatten()).to.deep.equal([1, 2, 3, 4]);
//   });
//
